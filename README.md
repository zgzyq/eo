...
```text
to-java.xsl              15597  24.41%
set-original-names.xsl   13202  20.66%
classes.xsl              9741   15.25%
set-locators.xsl         6114   9.57%
attrs.xsl                4719   7.39%
anonymous-to-nested.xsl  3780   5.92%
data.xsl                 3754   5.88%
tests.xsl                3670   5.74%
package.xsl              3316   5.19%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-08-19 at 07:09,
on Linux with 4 CPUs.
The total is 63893 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/32225486949
